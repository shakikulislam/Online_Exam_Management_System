    ...
    <div class="mainArea">
      <div class="areaTop">
        <div class="studentImage">
          <img class="studentImg" src="<?=imagelink($systemadmin->photo)?>" alt="">
        </div>
        <div class="studentProfile">
          ...
          <div class="singleItem">
            <div class="single_label"><?=$this->lang->line('systemadmin_role')?></div>
            <div class="single_value">: <?=isset($usertypes[$systemadmin->usertypeID]) ? $usertypes[$systemadmin->usertypeID] : ''?></div>
          </div>
          <div class="singleItem">
