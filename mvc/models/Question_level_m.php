...
class Question_level_m extends MY_Model {
    ...
    public function get_question_level($array=NULL, $signal=FALSE) 
    {
        $query = parent::get($array, $signal);
        return $query;
    }

    public function get_single_question_level($array) 
    {
        $query = parent::get_single($array);
        return $query;
    }

    public function get_order_by_question_level($array=NULL) 
    {
        $query = parent::get_order_by($array);
        return $query;
    }

    public function insert_question_level($array) 
    {
